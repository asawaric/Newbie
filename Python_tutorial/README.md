...
This tutorial contains total 9 chapters, each chapter written in a separate Jupyter Notebook document containing brief explanation of the main topic, it's commands, syntax and a model question explaining usage of these commands and syntax.
